...
F {}
E {}
N -150 -230 -150 -210 {lab=Vout}
N -200 -360 -200 -330 {lab=Vdd}
N -150 -150 -150 -120 {lab=#net1}
...
N -200 -270 -200 -240 {lab=Vout}
N -200 -240 -100 -240 {lab=Vout}
N -100 -270 -100 -240 {lab=Vout}
N -150 -240 -150 -230 {lab=Vout}
...
N -60 -300 -40 -300 {lab=B}
N -210 -180 -190 -180 {lab=A}
N -210 -90 -190 -90 {lab=B}
N -150 -220 -60 -220 {lab=Vout}
...
C {opin.sym} -60 -220 0 0 {name=p11 lab=Vout}
C {sky130_fd_pr/nfet_g5v0d10v5.sym} -170 -180 0 0 {name=M3
W=1
L=0.5
nf=1
mult=1
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} -220 -300 0 0 {name=M4
W=3
L=0.5
nf=1
mult=1
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} -80 -300 0 1 {name=M5
W=3
L=0.5
nf=1
mult=1
