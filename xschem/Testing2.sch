...
C {vsource.sym} -260 -130 2 0 {name=Vb_p value=0 savecurrent=false}
C {gnd.sym} -310 -200 2 0 {name=l4 lab=GND}
C {code_shown.sym} -30 -360 0 0 {name=s1 only_toplevel=false value="
...
.save all @m.xm2.msky130_fd_pr__pfet_01v8[id]
...
.control
 ...
 foreach val 1.5 3.0 3.0
  run
  let W_n = @m.xm2.msky130_fd_pr__pfet_01v8[w]
  let L_n = @m.xm2.msky130_fd_pr__pfet_01v8[l]
  let g_m_n = @m.xm2.msky130_fd_pr__pfet_01v8[gm]
  let i_d_n = @m.xm2.msky130_fd_pr__pfet_01v8[id]
  let v_th_n = @m.xm2.msky130_fd_pr__pfet_01v8[vth]
  let c_gg_n =  @m.xm2.msky130_fd_pr__pfet_01v8[cgg]
  let g_ds_n =  @m.xm2.msky130_fd_pr__pfet_01v8[gds]


  let gm_id_n = 'g_m_n/i_d_n'
  let v_ov_n = 'abs(v(g_p)) - abs(v_th_n)'
  ...
  *plot $plot_gm_id vs $plot_vov xlabel 'Overdrive Voltage V' ylabel 'Current Eff S/A' title 'NMOS gm/Id vs Vov'
  ...
  plot dc1.id_W_n vs dc1.gm_id_n dc2.id_W_n vs dc2.gm_id_n dc3.id_W_n vs dc3.gm_id_n xlabel 'Current Eff S/A' ylabel 'A/W' title 'PMOS Id/W vs gm/Id'
  plot dc1.gm_gmds_n vs dc1.gm_id_n dc2.gm_gmds_n vs dc2.gm_id_n dc3.gm_gmds_n vs dc3.gm_id_n xlabel 'Current Eff S/A' ylabel 'Intrinsic Gain' title 'PMOS gm/Id vs gm/gds'
  plot dc1.f_T_n vs dc1.gm_id_n dc2.f_T_n vs dc2.gm_id_n dc3.f_T_n vs dc3.gm_id_n xlabel 'Current Eff S/A' ylabel 'Transit Frequency GHz' title 'PMOS Id/W vs fT'
  ...
  plot dc1.gm_id_n dc2.gm_id_n dc3.gm_id_n xlabel 'Overdrive Voltage V' ylabel 'Current Eff S/A' title 'NMOS gm/Id vs Vsg'
